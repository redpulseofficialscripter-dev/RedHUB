...
local OrionLib = {
    ...
    Themes = {
        Default = {
        Main = Color3.fromRGB(45, 0, 0),        -- тёмно-красный фон
        Second = Color3.fromRGB(25, 0, 0),      -- ещё темнее для вкладок
        Stroke = Color3.fromRGB(80, 0, 0),      -- бордовый для обводок
        Divider = Color3.fromRGB(100, 0, 0),    -- разделители
        Text = Color3.fromRGB(255, 200, 200),   -- светло-красный текст
        TextDark = Color3.fromRGB(200, 120, 120), -- тёмный красный текст
        Icon = Color3.fromRGB(255, 120, 120),   -- иконки с красным оттенком
        Accent = Color3.fromRGB(220, 20, 20)    -- ярко-красный акцент
        },
        TokyoNightOld = {
